...
const LocationPickerScreen: React.FC<UserNavigationRootProps<"LocationScreen">> = (props) => {
  ...
  const fetchGooglePlaces = async (inputText: string) => {
    ...
    try {
      const response = await axios.get(
        `https://maps.googleapis.com/maps/api/place/autocomplete/json?input=${inputText}&key=AIzaSyCESGzn-f_ccP5pQ2xSo5PHaA-Z5B73HSY`
      );
  ...
  const handleSelectSuggestion = async (placeId: string, description: string) => {
    try {
      const response = await axios.get(
        `https://maps.googleapis.com/maps/api/place/details/json?place_id=${placeId}&key=AIzaSyCESGzn-f_ccP5pQ2xSo5PHaA-Z5B73HSY`
      );
            ...
            <View style={locationScreenStyles.searchBar}>
              <View style={locationScreenStyles.locationTextContainer}>
                ...
                <TextInput
                  ...
                  style={[locationScreenStyles.searchText, { paddingLeft: 35 }]}
                />
              </View>
